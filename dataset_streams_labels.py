...
def making_streams(input_path,output_path):
...
if __name__ == '__main__':   
    parser = argparse.ArgumentParser(description='turns the dataset Ditches&Streams into dataset Streams by removing the ditches from it',
    ...
    parser.add_argument('output_path', help='destination path to dataset Streams')
